...
function reversetab(){
var tab = [1, 2, 3]; 
return "reverseTab([1, 2, 3]) ➞" + tab.reverse();

}
console.log("exercice 17 :: " , reversetab())
...
return "getLastElem([1, 1, 2, 3, 5, 8, 13])➞ " + e
}

console.log("exercice 18 :: " , tableauder())

//exercice 19

function verification(a, b) {
    if (a === b){
        return "checkEq(("+a +", "+ b +") ➞" + true
    }else {
        return "checkEq(("+a +", "+ b +") ➞" + false
    }
}
console.log("exercice 19 :: " , verification(5 , "5"))
...
console.log("exercice 20 :: " , verification(''))